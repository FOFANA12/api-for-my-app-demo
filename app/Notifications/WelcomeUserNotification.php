...
class WelcomeUserNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->greeting(__('Salut').' !')
            ->line(__('Vous recevez cet email car vous êtes actuellement inscrit sur :name.',['name'=>setting('app.name',config('app.name'))]))
            ...
            ->action(__('Connexion'), url(config('app.url').'/login'));
    }
}
